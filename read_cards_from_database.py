...
Card: Beyonce
Category: Artist
Attribute Names: ['Singing Voice', 'Creativity', 'Painting', 'Composing']
Attribute Scores: {'Singing Voice': 10, 'Creativity': 7, 'Painting': 0, 'Composing': 5}

Card: Sinead O'Connor
Category: Artist
Attribute Names: ['Singing Voice', 'Creativity', 'Painting', 'Composing']
Attribute Scores: {'Singing Voice': 9, 'Creativity': 8, 'Painting': 0, 'Composing': 8}

Card: Ruth Bader Ginsburg
Category: Academic
Attribute Names: ['Intelligence', 'Political Influence', 'Determination', 'Rebellious']
Attribute Scores: {'Intelligence': 9, 'Political Influence': 9, 'Determination': 6, 'Rebellious': 9}
'''
